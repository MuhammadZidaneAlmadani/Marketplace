...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link" href="{{ url('/pasar-pengunjung') }}">Pasar</a></li>
    ...
    <div class="container market-section">
        ...
        <div class="text-center mt-4">
            <a href="#" class="btn btn-outline-dark">Lihat Semua Pasar &rarr;</a>
        </div>
    </div>
